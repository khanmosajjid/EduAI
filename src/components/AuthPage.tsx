...
import { BookOpen, ArrowLeft, Mail, Lock, User, Shield, Sparkles } from 'lucide-react';
...
interface AuthPageProps {
  onLogin: (user: { id: string; name: string; email: string; role: 'student' | 'admin' }) => void;
...
export function AuthPage({ onLogin, onBackToLanding }: AuthPageProps) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const isAdmin = loginData.email === 'admin@edu.com' && loginData.password === 'admin123';
      const user = {
        ...
        <div className="w-full max-w-md">
          ...
          <Tabs defaultValue="login" className="space-y-4">
            <TabsList className="grid w-full grid-cols-2 bg-slate-800 border-slate-600">
              <TabsTrigger value="login" className="text-gray-300 data-[state=active]:bg-slate-700 data-[state=active]:text-white">Email</TabsTrigger>
              <TabsTrigger value="signup" className="text-gray-300 data-[state=active]:bg-slate-700 data-[state=active]:text-white">Sign Up</TabsTrigger>
            </TabsList>
                ...
                <CardContent>
                  ...
                  <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <p className="text-xs text-blue-800">
                      🚀 <strong>Quick Start:</strong> Use Google or LinkedIn login above for instant access!
                    </p>
                  </div>
                </CardContent>
              </Card>
