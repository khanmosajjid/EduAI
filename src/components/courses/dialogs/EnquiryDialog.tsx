      ...
      <DialogContent className="bg-slate-800 border-slate-700 max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-300">
            Have questions about {course?.title}? Send us your enquiry and we'll get back to you promptly.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <Button 
            ...
            disabled={!form.name || !form.email || !form.subject || !form.message || !isFormEmailVerified || isSubmitting}
