        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="bg-slate-800/50 border-slate-700 backdrop-blur">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-300">
                Learn from AI experts who are currently shaping the industry
                with hands-on guidance and personalized feedback.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-slate-800/50 border-slate-700 backdrop-blur">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-300">
                Build real AI projects and gain practical experience with the
          ...
          <Card className="bg-slate-800/50 border-slate-700 backdrop-blur">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-300">
                Get a competitive advantage in your career with AI skills that
